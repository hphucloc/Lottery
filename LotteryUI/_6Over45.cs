...
namespace LotteryUI
{
    public partial class _6Over45 : Form
    {
        private List<LoterryStatistic> _6Over45No { get; set; }
        private List<LoterryStatistic> _Full6Over45No { get; set; }
        private DateTime datePublishFrom;
        private DateTime datePublishTo;
        public _6Over45(DateTime datePublishFrom, DateTime datePublishTo)
        {
            this.datePublishFrom = datePublishFrom;
            this.datePublishTo = datePublishTo;
            InitializeComponent();
            if (datePublishFrom == DateTime.MinValue)
            {
                _Full6Over45No = LotteryBusiness._6Over45TimeLine.Get6Over45Number(DateTime.MinValue, DateTime.MaxValue);
                _6Over45No = _Full6Over45No;
            }
            else
                _6Over45No = LotteryBusiness._6Over45TimeLine.Get6Over45Number(datePublishFrom, datePublishTo);

            this.labelMinDate.Text = _6Over45No[0].DatePublishMin.ToShortDateString();
            this.labelMaxDate.Text = _6Over45No[0].DatePublishMax.ToShortDateString();
            this.labelMinDate2.Text = _6Over45No[0].DatePublishMin.ToShortDateString();
            this.labelMaxDate2.Text = _6Over45No[0].DatePublishMax.ToShortDateString();
        ...
        private void DrawTimeLine(bool isFull = false)
        {
            var data = !isFull ? _6Over45No : _Full6Over45No;
        ...
        private void DrawTimeLine2(bool isFull = false)
        {
            ...
            lengendButton.BackColor = Color.DeepPink;
            ...
            txtNumberShouldBuy.Size = new Size(btnSize, 25);
            this.panel3.Controls.Add(txtNumberShouldBuy);
            Label lblTotalAppearupper40 = new Label();
            lblTotalAppearupper40.Location = new Point(10 + btnSize * 5, 260);
            lblTotalAppearupper40.Font = new Font("Arial", (float)12, FontStyle.Bold);
            this.panel3.Controls.Add(lblTotalAppearupper40);
            Label lblTotalAppearByColor = new Label();
            lblTotalAppearByColor.Location = new Point(10 + btnSize * 6, 260);
            ...
            var data = LotteryBusiness._6Over45TimeLine.Get6Over45Number(dataTimelineColor.FirstOrDefault()==null?
            ...
            foreach (var aNo in data)
            {
                ...
                sta1.Size = new Size(30, 20);
                sta1.Location = new Point(x, y + 20);
                ...
                {
                    countUpper40 += aNo.TotalNumberAppear;
                }
                //Get all publis Date               
            ...
            lblTotalAppearupper40.Text = countUpper40.ToString();
            ...
            foreach (var i in hitNumberByDate.AsEnumerable().Reverse())
            {
                ...
                foreach (var j in i.Value)
                {
                    ...
                    b.Text = j.ToString();
                    b.Font = new Font("Arial", (float) 5, FontStyle.Regular);
                    if (j >= 1 && j <= 7)
                    {
                        b.BackColor = Color.DarkRed;
        ...
        private void NumberButtonMouseEnter(object sender, EventArgs e)
        {
            ...
            var numberBought = _6Over45TimeLine.Get6Over45BoughtNumberPublishedInDate(Convert.ToDateTime(((CustomButton)sender).DatePublish));
            foreach (Control c in panel1.Controls)
            {
                if (c is CustomLabel)
                    if (((CustomLabel)c).Text.Equals(((CustomButton)sender).Number))
                ...
                if (c is CustomButton)
                {
                    ...
                    //foreach(var i in numberBought)
                    //{
                    //    if (((CustomButton)c).DatePublish == ((CustomButton)sender).DatePublish && i.ToString() == ((CustomButton)c).Number)
                    //    {
                    //        c.BackColor = Color.Yellow;
                    //    }
                    //}                    
            ...
            int[] tempNoAppear = new int[46];//Dai dien 45 so  
            ...
            //}
            //this.labelMessage.Text += "***" + temp;


            ////Count Next Appear
            //int[] nextNoAppear = new int[46];//Dai dien 45 so     
            //List<int> numberNextAppear = _6Over45TimeLine.GetNumberNextAppear(dateAppear);
        ...
        {
            new _FullShowNumber(((CustomButton)sender).Number, Enum_NumberType._6Over45, _Full6Over45No).ShowDialog();
        }
        ...
        {
            new _NumberNotAppear(_6Over45No).ShowDialog();
        }
        ...
        {           
                ...
                toolStripNo5.Text.Trim().Length >= 2 && toolStripNo6.Text.Trim().Length >= 2 && toolStripNo7.Text.Trim().Length >= 2)
            {
                ...
                new NoBet(result, (short)Enum_NumberType._6Over45, (short)Enum_NumberWinLevel.DacBiet).ShowDialog();
            }
        }
        ...
        {
            new _New6Over45Number(this.datePublishFrom, this.datePublishTo).ShowDialog();
        }
    }
}
